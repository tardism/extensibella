...
(defconst extensibella-top-commands
  '(
    ...
    ("\\<\\(\\(Theorem\\)\\|\\(Define\\)\\|\\(Import\\)\\|\\(Kind\\)\\|\\(Split\\)\\|\\(Type\\)\\|\\(Extensible_Theorem\\)\\|\\(Module\\)\\|\\(Prove\\)\\|\\(Projection_Constraint\\)\\|\\(Prove_Constraint\\)\\|\\(Ext_Ind\\)\\|\\(Prove_Ext_Ind\\)\\|\\(Ext_Size\\)\\|\\(Add_Ext_Size\\)\\|\\(Proj_Rel\\)\\|\\(Add_Proj_Rel\\)\\)\\>"
